                        ...
                        <div class="col-md-4 col-sm-4 navicons-topbar">
                            <ul>
                                <li class="blog-search">
                                    <a href="#" title="Search"><i class="fa fa-search" style="display:none;"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <nav class="main-menu">      
                                ...
                                if (Yii::$app->user->isGuest) {
                                    ...
                                    $menuItems[] = '<li>'
                                            ...
                                            . Html::submitButton(
                                                    'Выйти (' . Yii::$app->user->identity->username . ') <i class="fa fa-sign-out"></i>', ['class' => 'btn btn-link logout']
                                            )
                                            . Html::endForm()
                                            . '</li>';
                                }
