                            ...
                            <article class="post col-sm-12 col-xs-12">                                            
                                ...
                                <div class="post-bottom">
                                    ...
                                    <div class="post-comments">
                                        <a href="<?php echo Url::to(['/post/default/view', 'id' => $feedItem->post_id]); ?>"><?php $kol = $comments->getCount($feedItem->post_id); echo $kol['0']['COUNT(*)']; ?> Comments</a>
                                    </div>
                                    <div class="post-date">
                                    ...
                                    <div class="post-report">
                                        <?php if (!$feedItem->isReported($currentUser)): ?>
                                            <a href="#" class="btn btn-default button-complain" data-id="<?php echo $feedItem->post_id; ?>" style="font-size:12px;padding:5px 10px;">Пожаловаться <i class="fa fa-cog fa-spin fa-fw icon-preloader" style="display:none"></i>
                                            </a>
                                        <?php else: ?>
                                        <p>Жалоба уже отправлена</p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </article>
