...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function afterFind() // метод из коробки который вызывается сразу после того как запись будет найдена (видимо работает только с экземплярами класса ActiveRecord)
    {
